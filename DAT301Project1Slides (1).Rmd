...
USInflation = inflationDF %>% select(X2000:X2024) %>% filter(inflationDF$country_name == "United States")

CanadaInflation = inflationDF %>% select(X2000:X2024) %>% filter(inflationDF$country_name == "Canada")

ChinaInflation = inflationDF %>% select(X2000:X2024) %>% filter(inflationDF$country_name == "China, People's Republic of")

IndiaInflation = inflationDF %>% select(X2000:X2024) %>% filter(inflationDF$country_name == "India")

MexicoInflation = inflationDF %>% select(X2000:X2024) %>% filter(inflationDF$country_name == "Mexico")

RussiaInflation = inflationDF %>% select(X2000:X2024) %>% filter(inflationDF$country_name == "Russian Federation")
